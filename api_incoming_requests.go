...
func (r ApiIncomingRequestsConfirmRequestsRequest) Execute() (*_nethttp.Response, error) {
...
*/
func (a *IncomingRequestsApiService) IncomingRequestsConfirmRequests(ctx _context.Context, requestID string) ApiIncomingRequestsConfirmRequestsRequest {
	return ApiIncomingRequestsConfirmRequestsRequest{
		ApiService: a,
		ctx:        ctx,
		requestID:  requestID,
...
func (a *IncomingRequestsApiService) IncomingRequestsConfirmRequestsExecute(r ApiIncomingRequestsConfirmRequestsRequest) (*_nethttp.Response, error) {
	var (
...
func (r ApiIncomingRequestsGetRequestRequest) Execute() (IncomingRequest, *_nethttp.Response, error) {
...
*/
func (a *IncomingRequestsApiService) IncomingRequestsGetRequest(ctx _context.Context, requestID string) ApiIncomingRequestsGetRequestRequest {
	return ApiIncomingRequestsGetRequestRequest{
		ApiService: a,
		ctx:        ctx,
		requestID:  requestID,
...
func (a *IncomingRequestsApiService) IncomingRequestsGetRequestExecute(r ApiIncomingRequestsGetRequestRequest) (IncomingRequest, *_nethttp.Response, error) {
	var (
...
func (r ApiIncomingRequestsGetRequestsRequest) Execute() (IncomingRequest, *_nethttp.Response, error) {
...
*/
func (a *IncomingRequestsApiService) IncomingRequestsGetRequests(ctx _context.Context) ApiIncomingRequestsGetRequestsRequest {
	return ApiIncomingRequestsGetRequestsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
//  @return IncomingRequest
func (a *IncomingRequestsApiService) IncomingRequestsGetRequestsExecute(r ApiIncomingRequestsGetRequestsRequest) (IncomingRequest, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiIncomingRequestsRejectRequestsRequest) Execute() (*_nethttp.Response, error) {
...
*/
func (a *IncomingRequestsApiService) IncomingRequestsRejectRequests(ctx _context.Context, requestID string) ApiIncomingRequestsRejectRequestsRequest {
	return ApiIncomingRequestsRejectRequestsRequest{
		ApiService: a,
		ctx:        ctx,
		requestID:  requestID,
...
// Execute executes the request
func (a *IncomingRequestsApiService) IncomingRequestsRejectRequestsExecute(r ApiIncomingRequestsRejectRequestsRequest) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
