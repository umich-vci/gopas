...
func (r ApiRecordingsGetRecordingRequest) Execute() (map[string]interface{}, *_nethttp.Response, error) {
...
*/
func (a *RecordingsApiService) RecordingsGetRecording(ctx _context.Context, recordingId string) ApiRecordingsGetRecordingRequest {
	return ApiRecordingsGetRecordingRequest{
		ApiService:  a,
		ctx:         ctx,
...
func (a *RecordingsApiService) RecordingsGetRecordingExecute(r ApiRecordingsGetRecordingRequest) (map[string]interface{}, *_nethttp.Response, error) {
	var (
	...
	localVarPath = strings.Replace(localVarPath, "{"+"recordingId"+"}", _neturl.PathEscape(parameterToString(r.recordingId, "")), -1)
...
func (r ApiRecordingsGetRecordingActivitiesRequest) Execute() (map[string]interface{}, *_nethttp.Response, error) {
...
*/
func (a *RecordingsApiService) RecordingsGetRecordingActivities(ctx _context.Context, recordingId string) ApiRecordingsGetRecordingActivitiesRequest {
	return ApiRecordingsGetRecordingActivitiesRequest{
		ApiService:  a,
		ctx:         ctx,
		recordingId: recordingId,
...
// Execute executes the request
//  @return map[string]interface{}
func (a *RecordingsApiService) RecordingsGetRecordingActivitiesExecute(r ApiRecordingsGetRecordingActivitiesRequest) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiRecordingsGetRecordingFileValidityStatusRequest) Execute() (map[string]interface{}, *_nethttp.Response, error) {
...
*/
func (a *RecordingsApiService) RecordingsGetRecordingFileValidityStatus(ctx _context.Context, recordingId string) ApiRecordingsGetRecordingFileValidityStatusRequest {
	return ApiRecordingsGetRecordingFileValidityStatusRequest{
		ApiService:  a,
		ctx:         ctx,
		recordingId: recordingId,
...
// Execute executes the request
//  @return map[string]interface{}
func (a *RecordingsApiService) RecordingsGetRecordingFileValidityStatusExecute(r ApiRecordingsGetRecordingFileValidityStatusRequest) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiRecordingsGetRecordingPropertiesRequest) Execute() (map[string]interface{}, *_nethttp.Response, error) {
...
*/
func (a *RecordingsApiService) RecordingsGetRecordingProperties(ctx _context.Context, recordingId string) ApiRecordingsGetRecordingPropertiesRequest {
	return ApiRecordingsGetRecordingPropertiesRequest{
		ApiService:  a,
		ctx:         ctx,
		recordingId: recordingId,
...
// Execute executes the request
//  @return map[string]interface{}
func (a *RecordingsApiService) RecordingsGetRecordingPropertiesExecute(r ApiRecordingsGetRecordingPropertiesRequest) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiRecordingsGetRecordingsRequest) Execute() (SessionData, *_nethttp.Response, error) {
...
*/
func (a *RecordingsApiService) RecordingsGetRecordings(ctx _context.Context) ApiRecordingsGetRecordingsRequest {
	return ApiRecordingsGetRecordingsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
//  @return SessionData
func (a *RecordingsApiService) RecordingsGetRecordingsExecute(r ApiRecordingsGetRecordingsRequest) (SessionData, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiRecordingsPlayRecordingRequest) Execute() (map[string]interface{}, *_nethttp.Response, error) {
...
*/
func (a *RecordingsApiService) RecordingsPlayRecording(ctx _context.Context, recordingId string) ApiRecordingsPlayRecordingRequest {
	return ApiRecordingsPlayRecordingRequest{
		ApiService:  a,
		ctx:         ctx,
		recordingId: recordingId,
...
// Execute executes the request
//  @return map[string]interface{}
func (a *RecordingsApiService) RecordingsPlayRecordingExecute(r ApiRecordingsPlayRecordingRequest) (map[string]interface{}, *_nethttp.Response, error) {
	var (
