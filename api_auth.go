...
func (r ApiAuthLogoffRequest) Execute() (LogoffData, *_nethttp.Response, error) {
...
*/
func (a *AuthApiService) AuthLogoff(ctx _context.Context) ApiAuthLogoffRequest {
	return ApiAuthLogoffRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//  @return LogoffData
func (a *AuthApiService) AuthLogoffExecute(r ApiAuthLogoffRequest) (LogoffData, *_nethttp.Response, error) {
	var (
...
func (r ApiAuthLogonRequest) Execute() (*_nethttp.Response, error) {
...
*/
func (a *AuthApiService) AuthLogon(ctx _context.Context, type_ string) ApiAuthLogonRequest {
	return ApiAuthLogonRequest{
		ApiService: a,
		ctx:        ctx,
		type_:      type_,
...
// Execute executes the request
func (a *AuthApiService) AuthLogonExecute(r ApiAuthLogonRequest) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
