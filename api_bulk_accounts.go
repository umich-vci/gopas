...
func (r ApiBulkAccountsAddBulkAccountsRequest) Execute() (map[string]interface{}, *_nethttp.Response, error) {
...
*/
func (a *BulkAccountsApiService) BulkAccountsAddBulkAccounts(ctx _context.Context) ApiBulkAccountsAddBulkAccountsRequest {
	return ApiBulkAccountsAddBulkAccountsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *BulkAccountsApiService) BulkAccountsAddBulkAccountsExecute(r ApiBulkAccountsAddBulkAccountsRequest) (map[string]interface{}, *_nethttp.Response, error) {
	var (
...
func (r ApiBulkAccountsGetBulkActionRequest) Execute() (BulkAccountsOperationResultExtended, *_nethttp.Response, error) {
...
*/
func (a *BulkAccountsApiService) BulkAccountsGetBulkAction(ctx _context.Context, bulkId int64) ApiBulkAccountsGetBulkActionRequest {
	return ApiBulkAccountsGetBulkActionRequest{
		ApiService: a,
		ctx:        ctx,
		bulkId:     bulkId,
...
func (a *BulkAccountsApiService) BulkAccountsGetBulkActionExecute(r ApiBulkAccountsGetBulkActionRequest) (BulkAccountsOperationResultExtended, *_nethttp.Response, error) {
	var (
...
func (r ApiBulkAccountsGetUserBulkAccountsActionsRequest) Execute() (GetBulkAccountsActionsResult, *_nethttp.Response, error) {
...
*/
func (a *BulkAccountsApiService) BulkAccountsGetUserBulkAccountsActions(ctx _context.Context) ApiBulkAccountsGetUserBulkAccountsActionsRequest {
	return ApiBulkAccountsGetUserBulkAccountsActionsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *BulkAccountsApiService) BulkAccountsGetUserBulkAccountsActionsExecute(r ApiBulkAccountsGetUserBulkAccountsActionsRequest) (GetBulkAccountsActionsResult, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
