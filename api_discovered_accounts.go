...
func (r ApiDiscoveredAccountsAddDiscoveredAccountRequest) Execute() (DiscoveredAccountResponse, *_nethttp.Response, error) {
...
*/
func (a *DiscoveredAccountsApiService) DiscoveredAccountsAddDiscoveredAccount(ctx _context.Context) ApiDiscoveredAccountsAddDiscoveredAccountRequest {
	return ApiDiscoveredAccountsAddDiscoveredAccountRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *DiscoveredAccountsApiService) DiscoveredAccountsAddDiscoveredAccountExecute(r ApiDiscoveredAccountsAddDiscoveredAccountRequest) (DiscoveredAccountResponse, *_nethttp.Response, error) {
	var (
...
func (r ApiDiscoveredAccountsDeleteDiscoveredAccountsRequest) Execute() (map[string]interface{}, *_nethttp.Response, error) {
...
*/
func (a *DiscoveredAccountsApiService) DiscoveredAccountsDeleteDiscoveredAccounts(ctx _context.Context) ApiDiscoveredAccountsDeleteDiscoveredAccountsRequest {
	return ApiDiscoveredAccountsDeleteDiscoveredAccountsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *DiscoveredAccountsApiService) DiscoveredAccountsDeleteDiscoveredAccountsExecute(r ApiDiscoveredAccountsDeleteDiscoveredAccountsRequest) (map[string]interface{}, *_nethttp.Response, error) {
	var (
...
func (r ApiDiscoveredAccountsGetDiscoveredAccountRequest) Execute() (GetDiscoveredAccount, *_nethttp.Response, error) {
...
*/
func (a *DiscoveredAccountsApiService) DiscoveredAccountsGetDiscoveredAccount(ctx _context.Context, id string) ApiDiscoveredAccountsGetDiscoveredAccountRequest {
	return ApiDiscoveredAccountsGetDiscoveredAccountRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
func (a *DiscoveredAccountsApiService) DiscoveredAccountsGetDiscoveredAccountExecute(r ApiDiscoveredAccountsGetDiscoveredAccountRequest) (GetDiscoveredAccount, *_nethttp.Response, error) {
	var (
...
func (r ApiDiscoveredAccountsGetDiscoveredAccountsRequest) Execute() (GetDiscoveredAccountsResponse, *_nethttp.Response, error) {
...
*/
func (a *DiscoveredAccountsApiService) DiscoveredAccountsGetDiscoveredAccounts(ctx _context.Context) ApiDiscoveredAccountsGetDiscoveredAccountsRequest {
	return ApiDiscoveredAccountsGetDiscoveredAccountsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *DiscoveredAccountsApiService) DiscoveredAccountsGetDiscoveredAccountsExecute(r ApiDiscoveredAccountsGetDiscoveredAccountsRequest) (GetDiscoveredAccountsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
